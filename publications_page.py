...
def print_publications_page():
    ...
    The publication is currently available as preprint via: [Transformers enable accurate prediction of acute and chronic chemical toxicity in aquatic organisms](https://www.biorxiv.org/content/10.1101/2023.04.17.537138v1)
